...
print(f"Tax charge :{tax_amount:.6f}")
print()
...
print(f"Your total bill with tip was {customers_tip + subtotal}:.2f")
customers_payment = float(input("how much did you pay $"))
print(f"Your change is {customers_payment - (subtotal + customers_tip)}:.2f")
